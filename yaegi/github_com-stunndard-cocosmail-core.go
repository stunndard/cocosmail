...
func init() {
	Symbols["github.com/stunndard/cocosmail/core/core"] = map[string]reflect.Value{
		...
		"CocosmailPlugins":                 reflect.ValueOf(&core.CocosmailPlugins).Elem(),
		...
		"DeliverdPlugins":                  reflect.ValueOf(&core.DeliverdPlugins).Elem(),
		...
		"RegisterDeliverdPlugin":           reflect.ValueOf(core.RegisterDeliverdPlugin),
		"RegisterPlugin":                   reflect.ValueOf(core.RegisterPlugin),
		"RegisterSMTPdPlugin":              reflect.ValueOf(core.RegisterSMTPdPlugin),
		...
		"SMTPdPlugins":                     reflect.ValueOf(&core.SMTPdPlugins).Elem(),
		...
		"CocosmailPlugin":   reflect.ValueOf((*core.CocosmailPlugin)(nil)),
		"Config":            reflect.ValueOf((*core.Config)(nil)),
		"DeliverdAuth":      reflect.ValueOf((*core.DeliverdAuth)(nil)),
		"DeliverdPlugin":    reflect.ValueOf((*core.DeliverdPlugin)(nil)),
		...
		"SMTPdPlugin":       reflect.ValueOf((*core.SMTPdPlugin)(nil)),
